 ...
 * ```
 */
export declare function createCustomError<T extends ErrorConstructor = CustomErrorConstructor, B extends ErrorConstructor = ErrorConstructor>(name: string, constructCb?: ((self: any, args: IArguments) => void) | null, errorBase?: B, superArgsFn?: ((args: IArguments) => ArrayLike<any>) | null): T;
 ...
 * ```
 */
export declare function decodeHex(value: string): string;
 ...
 * ```
 */
export declare function decodeUri(value: string): string;
 ...
 * ```
 */
export declare function encodeAsBase64(value: string): string;
 ...
 * ```
 */
export declare function encodeAsBase64Url(value: string): string;
 ...
 * ```
 */
export declare function encodeAsHex(value: string): string;
 ...
 * ```
 */
export declare function encodeAsUri(value: string): string;
 ...
 * ```
 */
export declare function getDeferred<R, F extends (...args: any[]) => R = (...args: any[]) => R>(cb: F | ((...args: Parameters<F>) => R), argArray?: Parameters<F>): ICachedValue<R>;
 ...
 * ```
 */
export declare function getLazy<T, F extends (...args: any[]) => T = (...args: any[]) => T>(cb: F | ((...args: Parameters<F>) => T), argArray?: Parameters<F>): ILazyValue<T>;
 ...
 * ```
 */
export declare function getWritableDeferred<R, F extends (...args: any[]) => R = (...args: any[]) => R>(cb: F | ((...args: Parameters<F>) => R), argArray?: Parameters<F>): ICachedValue<R>;
 ...
 * ```
 */
export declare function getWritableLazy<T, F extends (...args: any[]) => T = () => T>(cb: F | ((...args: Parameters<F>) => T), argArray?: Parameters<F>): ILazyValue<T>;
 ...
 * ```
 */
export declare function safe<F extends (...args: unknown[]) => R, R = ReturnType<F>>(func: F, argArray?: any[]): ISafeReturn<F, R>;
 ...
 * ```
 */
export declare function safeGet<T, F extends (...args: any[]) => T = (...args: any[]) => T>(cb: F | ((...args: Parameters<F>) => T), defValue: T, argArray?: Parameters<F>): T;
 ...
 * ```
 */
export declare function safeGetDeferred<T, F extends (...args: any[]) => T = (...args: any[]) => T>(cb: F | ((...args: Parameters<F>) => T), defValue: T, argArray?: Parameters<F>): ICachedValue<T>;
 ...
 * ```
 */
export declare function safeGetLazy<T = boolean, F extends (...args: any[]) => T = (...args: any[]) => T>(cb: F | ((...args: Parameters<F>) => T), defValue: T, argArray?: Parameters<F>): ILazyValue<T>;
 ...
 * ```
 */
export declare function safeGetWritableDeferred<T, F extends (...args: any[]) => T = (...args: any[]) => T>(cb: F | ((...args: Parameters<F>) => T), defValue: T, argArray?: Parameters<F>): ICachedValue<T>;
 ...
 * ```
 */
export declare function safeGetWritableLazy<T = boolean, F extends (...args: any[]) => T = (...args: any[]) => T>(cb: F | ((...args: Parameters<F>) => T), defValue: T, argArray?: Parameters<F>): ILazyValue<T>;
